...
if(isset($_POST['submit'])){ // jika tombol 'Simpan' dengan properti name="add" pada baris 137 ditekan
				$id		     = $_POST['id'];
				$name		     = $_POST['name'];
				$email   = $_POST['email'];
...
<body>
    ...
    <div class="bg-light border-bottom shadow-sm sticky-top">
        ...
        <div class="container">
            ...
            <h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-4-with-search-functionality/">Add Users</a>
            </h1>
		...
		if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="un"){
			...
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> User id is mandatory field!</div>';
		...
		?>
            ...
            <div class="card">
                ...
                <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add User</strong> <a
                        href="browse-users.php" class="float-right btn btn-dark btn-sm"><i
                    ...
                    <div class="col-sm-6">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="id" name="id" id="id" class="form-control" placeholder="Enter Id" required>
